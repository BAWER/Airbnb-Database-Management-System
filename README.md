...
4.	To verify the data volume, open a new query tab and execute:                       SELECT * FROM booking; This will display the core transaction data to confirm the data insertion was successful.
